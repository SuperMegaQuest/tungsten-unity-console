...
#region Fields
    ...
    private Color _inputContainerBackgroundColor;

    [SerializeField] private Color _inputTextColor;

    [Header("Log Text"), SerializeField,]
    private Color _logTextErrorColor;
    ...
    [Header("Log Background"), SerializeField,]
    ...
    private readonly Dictionary<LogType, Color> _logTextColor = new();
    private readonly Dictionary<LogType, Color> _logBackgroundColor = new();
#endregion Fields
