...
#region Fields
    ...
    [Header("History"), SerializeField,]
    private ConsoleHistory _consoleHistory;

    [Tooltip("Set to -1 to not limit the number of logs stored"), SerializeField,]
    private int _logHistoryCapacity = -1;

    [Tooltip("Set to -1 to not limit the number of commands stored"), SerializeField,]
    private int _commandHistoryCapacity = -1;

    [Header("Core Commands"), SerializeField,]
    private bool _enableCoreCommands = true;

    [Header("Unity Log Settings"), SerializeField,]
    private bool _logUnityErrors = true;
    ...
    [Header("Console View"), SerializeField,]
    private bool _instantiateView = true;

    [Tooltip("Select which console view implementation to use."), SerializeField,]
    private ConsoleView _viewPrefab;
#endregion Fields
